...
function ProjectsCard({ cardProps, modalProps }) {
  ...
  return (
    <Card
      shadow={true}
      className="relative grid items-end justify-center overflow-hidden text-center rounded-sm h-[550px] max-w-sm"
    >
      <CardHeader
        floated={false}
        shadow={false}
      ...
      <CardBody className="relative py-14 px-6 md:px-12">
        ...
        <CardFooter className="pt-0">
          <Button onClick={handleOpen} className="font-raleway bg-primary">
            Leer más
          </Button>
          <ProjectModal
            open={open}
