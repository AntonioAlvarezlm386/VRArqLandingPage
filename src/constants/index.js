...
import { creativity, funcionality, innovation, serv1, serv2, serv3, serv4, project1 } from '../assets/img';
...
export const projects = [
    {
        title: "project 1",
        description : "En nuestro último proyecto de remodelación interior, nos sumergimos en la transformación de una casa habitación tradicional en un espacio contemporáneo y funcional. Fusionando elementos modernos con la calidez del hogar, replanteamos cada detalle para maximizar la luminosidad y la amplitud.",
        img : project1
    },
    {
        title: "project 1",
