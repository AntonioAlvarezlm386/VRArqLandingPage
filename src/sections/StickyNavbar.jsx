...
const StickyNavbar = () => {
    ...
    const navList = (
      <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 font-raleway">
        <Typography
          as="li"
          variant="small"
          color="blue-gray"
    ...
    return (
      <div id="home" className="max-h-[768px] w-[calc(100%+48px)] overflow-scroll ">
