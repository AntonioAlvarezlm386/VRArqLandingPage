  ...
  return (
    <div id="about" className="max-container mt-10 md:px-10 xl:px-16">
      ...
      <div className="relative h-[850px] flex justify-center xl:justify-end overflow-x-hidden">
        ...
        >
          <h3 className="font-playfair text-[20.74pt] my-4 text-center">
            Misión
          </h3>
          ...
          <p className="font-raleway mb-4 text-secondary-text">
            Aspiramos a ser reconocidos como un estudio que trasciende las
            expectativas, fusionando la innovación con la funcionalidad para
            crear espacios que satisfagan las necesidades del presente y que
            también se conviertan en referentes atemporales de la arquitectura
            contemporánea.
          </p>
        </div>
        <img
          src="https://res.cloudinary.com/dkrsandox/image/upload/v1706571975/Rafa_Page/abou2_bqb0od.webp"
          alt="interior"
          width={500}
        />
        <img
          src="https://res.cloudinary.com/dkrsandox/image/upload/v1706572986/Rafa_Page/about2_mf4ikj.webp"
          alt="fachada"
        />
      </div>
    </div>
